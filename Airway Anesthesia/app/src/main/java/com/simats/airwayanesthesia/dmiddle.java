...
public class dmiddle extends AppCompatActivity {
   // String value = "o9ij";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dmiddle);
