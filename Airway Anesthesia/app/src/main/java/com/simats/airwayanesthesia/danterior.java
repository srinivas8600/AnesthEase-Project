...
public class danterior extends AppCompatActivity {
    String value = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_danterior);
