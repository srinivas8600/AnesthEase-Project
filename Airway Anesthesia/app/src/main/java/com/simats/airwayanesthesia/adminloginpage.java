...
public class adminloginpage extends AppCompatActivity {
    ...
    private String URL = ip.ipn+"login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eid = findViewById(R.id.e1);
        epassword = findViewById(R.id.p1);
        ...
        EditText passwordEditText = findViewById(R.id.p1);
...
// Set the OnTouchListener to detect clicks on the drawable
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!username.isEmpty() && !password.isEmpty()) {
                    ...
                    Toast.makeText(adminloginpage.this, "Fields cannot be empty1111", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void handleResponse(String response) {
        ...
        if ("success".equals(status)) {
            ...
            Toast.makeText(adminloginpage.this, "Invalid login", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void handleError(VolleyError error) {
        if (error instanceof TimeoutError) {
            Toast.makeText(adminloginpage.this, "Request timed out. Check your internet connection.", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(adminloginpage.this, error.toString().trim(), Toast.LENGTH_SHORT).show();
        }
    }
}