...
public class dposterior extends AppCompatActivity {
    String value = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dposterior);
        ...
        fetchData(value);
        Button isbn15Button = findViewById(R.id.bn16);
        // Set an OnClickListener to the button
        isbn15Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Perform action to move to document dashboard
                Intent intent = new Intent(dposterior.this, docdashboard.class);
