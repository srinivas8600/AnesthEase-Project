...
public class AprofileE extends AppCompatActivity {
    ...
    String value;
    private String URL = ip.ipn+"aprofileuu.php";
    ...
    ActivityResultLauncher<String> cameraPermission = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean o) {
            Toast.makeText(AprofileE.this,(o)? "Camera Permission Granted" : "Camera Permission Denied", Toast.LENGTH_SHORT).show();
        }
    });
    ...
    ActivityResultLauncher<String> imagesPermission = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        @Override
        public void onActivityResult(Boolean o) {
            Toast.makeText(AprofileE.this,(o)? "Media Permission Granted" : "Media Permission Denied", Toast.LENGTH_SHORT).show();
        }
    });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aprofile_e);
    ...
    private void pickImageFromGallery() {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if(!(ContextCompat.checkSelfPermission(this, android.Manifest.permission.READ_MEDIA_IMAGES)== PackageManager.PERMISSION_GRANTED)) {
                ...
                imagesPermission.launch(Manifest.permission.READ_MEDIA_IMAGES);
                return;
            }
        }
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
                        ...
                        if (result.getData() != null) {
                            try {
                                ...
                                Bitmap bitmap = MediaStore.Images.Media.getBitmap(
                                        AprofileE.this.getContentResolver(),
                                        selectedImageUri
                                );
    ...
    private void sendJsonData() {
        ...
        if (tx1.isEmpty() || tx3.isEmpty() || tx5.isEmpty() || tx6.isEmpty()) {
            Toast.makeText(AprofileE.this, "Please fill all the fields", Toast.LENGTH_SHORT).show();
            return;
        }
...
//            Log.e("sf","da"+jsonData);
                        ...
                        try {
                            ...
                            if (response.has("status")) {
                                ...
                                if ("success".equals(status)) {
                                    ...
                                    Toast.makeText(AprofileE.this, message, Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(AprofileE.this, admindashboard.class);
    ...
    private void fetchStringFromPHP() {
        String url = ip.ipn+"aprofile.php";
...
//                    textView1.setText("Error: " + e.getMessage());
                    ...
                    Toast.makeText(AprofileE.this, e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
