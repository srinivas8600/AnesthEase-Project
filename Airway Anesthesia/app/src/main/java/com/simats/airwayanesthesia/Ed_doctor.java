...
public class Ed_doctor extends AppCompatActivity {
    ...
    String value;
    private String URL = ip.ipn+"MMM.php";
    ...
    ActivityResultLauncher<String> imagesPermission = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        @Override
        public void onActivityResult(Boolean o) {
            Toast.makeText(activity, (o) ? "Media Permission Granted" : "Media Permission Denied", Toast.LENGTH_SHORT).show();
        }
    });
                        ...
                        if (result.getData() != null) {
                            try {
                                ...
                                Bitmap bitmap = MediaStore.Images.Media.getBitmap(
                                        Ed_doctor.this.getContentResolver(),
                                        selectedImageUri
                                );
    ...
    private void sendJsonData() {
        ...
        if(tx1.isEmpty() || tx3.isEmpty() || tx5.isEmpty() || tx6.isEmpty() || tx7.isEmpty()) {
    ...
    private void fetchStringFromPHP() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                textView7 = findViewById(R.id.tx6);
                img=findViewById(R.id.img33);
                try {
                    Gson gson = new Gson();
...
//                    textView1.setText("Error: " + e.getMessage());
                    ...
                    Toast.makeText(Ed_doctor.this, e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
