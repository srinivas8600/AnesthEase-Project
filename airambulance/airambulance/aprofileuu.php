...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($data !== null) {
        ...
        $q1 = "SELECT img FROM adminprofile WHERE id='$field4'";
        ...
        if (file_put_contents($imagePath, base64_decode($profile_img))) {
            ...
            $sql = "UPDATE adminprofile SET name ='$field1', phno = '$field2', gender = '$field3', email = '$field5',  img = '$imagePath' WHERE id = '$field4' ";
